...
<form action="UpdatePassword" method="post">
  ...
  <div class="panel-body resize-body center-block">
				...
				<label for="emailAddress"><font color="#0" size="4">Email</font></label> 
					<br>
					<input type="emailAddress" class="form-control" name=emailAddress>
					<label for="password"><font color="#0" size="4">Current Password</font></label> 
					<br>
					<input type="currentpassword" class="form-control" name=currentpassword>
