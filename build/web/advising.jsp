		    				...
		    				$(document).ready(function(){
		 		    		...
		 		    		<% int i = 0;
									...
									for (i=0;i<schedules.size();i++){%> 
		 								{
                                                                                    <%
                                                                             if (schedules.size() != 0 && ((Integer.parseInt(schedules.get(i).getDate().substring(5, 7)))< ca.get(Calendar.MONTH)) ){%>
										...
										for(i=1;i<1+appointments.size();i++){%>
		 									{
                                                                                          <%  
                                                                                                ...
                                                                                                if (appointments.size() != 0 && ((Integer.parseInt(appointments.get(i-1).getAdvisingDate().substring(5, 7)))< ca.get(Calendar.MONTH)) ){%>
